...
static const int core_millivolts[MAX_DVFS_FREQS] =
	{950, 1000, 1100, 1200, 1250, 1300, 1400};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1050, 1150, 1250, 1325, 1350};
#elif CONFIG_TEGRA_OC_1P6
static const int core_millivolts[MAX_DVFS_FREQS] =
	{950, 1000, 1100, 1200, 1250, 1325, 1425};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{750, 775, 800, 825, 850, 850, 900, 900, 950, 975, 1000, 1075, 1200, 1275, 1350, 1375};

/*#elif CONFIG_TEGRA_OC_1P7*/
/*NOT IMPLEMENTED YET*/
/*static const int core_millivolts[MAX_DVFS_FREQS] =
	{950, 1000, 1100, 1200, 1250, 1325, 1425};
static const int cpu_millivolts[MAX_DVFS_FREQS] =
	{750, 775, 800, 825, 850, 875, 900, 925, 950, 975, 1000, 1025, 1150, 1275, 1350, 1375, 1400};*/
#else
static const int core_millivolts[MAX_DVFS_FREQS] =
...
static struct dvfs dvfs_init[] = {
...
#ifdef CONFIG_TEGRA_OC
	/*Cpu voltages (mV):	   750, 775, 800, 825, 850, 900,  950,  975,  1000, 1050, 1100, 1150, 1200, 1275, 1325, 1350 */
...
#elif CONFIG_TEGRA_OC_1P6
	/*Cpu voltages (mV):	   750, 775, 800, 825, 850, 875,  900,  925,  950,  975,  1000, 1050, 1150, 1275, 1350, 1375 */
	...
	CORE_DVFS("mpe",      0, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000, 300000),
	CORE_DVFS("mpe",      1, 1, KHZ, 190000, 237500, 300000, 300000, 300000, 300000, 300000),
	...
	CORE_DVFS("sclk",     0, 1, KHZ, 152000, 180500, 229500, 260000, 260000, 285000, 300000),
	...
	CORE_DVFS("vde",      0, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000, 300000),
	CORE_DVFS("vde",      1, 1, KHZ, 152000, 209000, 285000, 300000, 300000, 300000, 300000),
